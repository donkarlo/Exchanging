...
class RoleController extends Controller {
    ...
    public function indexAction() {
        ...
        $roles = $em->getRepository('NdrmAuthBundle:Role')->findAll();

        return $this->render('NdrmAuthBundle:Role/Crud:index.html.twig', array(
                    'roles' => $roles,
        ));
    }
    ...
    public function newAction(Request $request) {
        $role = new Role();
        $form = $this->createForm('Ndrm\AuthBundle\Form\RoleType', $role);
        ...
        return $this->render('NdrmAuthBundle:Role/Crud:new.html.twig', array(
                    'role' => $role,
    ...
    public function showAction(Role $role) {
        ...
        return $this->render('NdrmAuthBundle:Role/Crud:show.html.twig', array(
                    'role' => $role,
    ...
    public function editAction(Request $request, Role $role) {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('Ndrm\AuthBundle\Form\RoleType', $role);
        $editForm->handleRequest($request);
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();
            return $this->redirectToRoute('role_edit', array('id' => $role->getId()));
        }
        return $this->render('NdrmAuthBundle:Role/Crud:edit.html.twig', array(
                    'role' => $role,
